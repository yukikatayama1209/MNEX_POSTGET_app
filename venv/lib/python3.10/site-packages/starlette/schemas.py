...
class BaseSchemaGenerator:
    ...
    def get_endpoint(self, routes: list[BaseRoute]) -> list[EndpointInfo]:
        """
        ...
        """
        endpoint_info: list[EndpointInfo] = []
        ...
        for route in routes:
            if isinstance(route, (Mount, Host)):
                ...
                sub_endpoint = [
                    ...
                    for sub_endpoint in self.get_endpoint(routes)
                ]
                endpoint_info.extend(sub_endpoint)
                ...
                for method in ["get", "post", "put", "patch", "delete", "options"]:
                    ...
                    endpoint_info.append(EndpointInfo(path, method.lower(), func))
...
class SchemaGenerator(BaseSchemaGenerator):
    ...
    def get_schema(self, routes: list[BaseRoute]) -> dict[str, typing.Any]:
        ...
        endpoint_info = self.get_endpoint(routes)
