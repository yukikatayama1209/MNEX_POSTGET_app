...
class TestTrivialCurve(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # need to find a scalar that creates one of the point on a curve that
        # has x coordinate equal to zero.
        # Even for secp112r2 curve that's non trivial so use this toy
        # curve, for which we can iterate over all point quickly
...
def test_VerifyingKey_inequality_with_different_secret_point():
    sk1 = SigningKey.from_secret_exponent(2, BRAINPOOLP160r1)
