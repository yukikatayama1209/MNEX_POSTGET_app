...
class TestJacobi(unittest.TestCase):
    ...
    @example(3, 3)
    def test_add_scaled_point(self, a_mul, b_mul):
    ...
    def test_add_same_scale_point(self, a_mul, b_mul, new_z):
        j_g = PointJacobi.from_affine(generator_brainpoolp160r1)
        a = PointJacobi.from_affine(j_g * a_mul)
        b = PointJacobi.from_affine(j_g * b_mul)
    ...
    def test_add_same_scale_point_static(self):
    ...
    def test_add_different_scale_point(self, a_mul, b_mul, new_z):
        j_g = PointJacobi.from_affine(generator_brainpoolp160r1)
        a = PointJacobi.from_affine(j_g * a_mul)
        b = PointJacobi.from_affine(j_g * b_mul)
    ...
    def test_add_different_scale_point_static(self):
        j_g = generator_brainpoolp160r1
        p = curve_brainpoolp160r1.p()
        a = j_g * 11
        a.scale()
    ...
    def test_add_different_point_same_scale_static(self):
        j_g = generator_brainpoolp160r1
        p = curve_brainpoolp160r1.p()
        a = j_g * 11
        a.scale()
