...
from pkg_resources import (
    ...
    safe_version, yield_lines, EntryPoint, iter_entry_point, to_filename)
...
class egg_info(InfoCommon, Command):
    ...
    def run(self):
        ...
        for ep in iter_entry_point('egg_info.writers'):
...
def write_entries(cmd, basename, filename):
    ep = cmd.distribution.entry_point
    ...
    cmd.write_or_delete_file('entry point', filename, data, True)
