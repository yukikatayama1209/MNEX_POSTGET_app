...
def check_entry_point(dist, attr, value):
    """Verify that entry_point map is parseable"""
    try:
...
class Distribution(_Distribution):
    ...
    def __init__(self, attrs=None):
        ...
        for ep in pkg_resources.iter_entry_point('distutils.setup_keywords'):
    ...
    def _finalize_requires(self):
        ...
        if getattr(self, 'extras_require', None):
            for extra in self.extras_require.keys():
                # Since this gets called multiple times at point where the
    ...
    def finalize_options(self):
        ...
        defined = pkg_resources.iter_entry_point(group)
    ...
    def get_command_class(self, command):
        ...
        eps = pkg_resources.iter_entry_point('distutils.commands', command)
        for ep in eps:
            ep.require(installer=self.fetch_build_egg)
    ...
    def print_commands(self):
        for ep in pkg_resources.iter_entry_point('distutils.commands'):
