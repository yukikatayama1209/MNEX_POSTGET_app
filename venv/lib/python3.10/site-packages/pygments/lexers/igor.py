...
class IgorLexer(RegexLexer):
    ...
    operations = (
        ...
        'DelayUpdate', 'DeleteAnnotations', 'DeleteFile', 'DeleteFolder', 'Deletepoint',
        ...
        'FindDuplicates', 'FindLevel', 'FindLevels', 'FindPeak', 'FindpointInPoly',
        ...
        'HDF5LoadData', 'HDF5LoadGroup', 'HDF5LoadImage', 'HDF5OpenFile',
         ...
         'IndexSort', 'Insertpoint', 'InstantFrequency', 'Integrate', 'IntegrateODE',
