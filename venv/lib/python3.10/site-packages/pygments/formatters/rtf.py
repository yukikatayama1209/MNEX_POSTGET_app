...
class RtfFormatter(Formatter):
    ...
    `fontsize`
        Size of the font used. Size is specified in half point. The
        default is 24 half-point, giving a size 12 font.
    ...
    `lineno_fontsize`
        Font size for line numbers. Size is specified in half point
        (default: `fontsize`). 
