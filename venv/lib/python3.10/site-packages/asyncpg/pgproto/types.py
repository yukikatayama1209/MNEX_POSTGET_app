...
class Path:
    ...
    __slots__ = '_is_closed', 'point'

    point: typing.Tuple[Point, ...]

    def __init__(self, *point: typing.Sequence[float],
                 is_closed: bool = False) -> None:
        self.point = tuple(Point(*p) for p in point)
    ...
    def __hash__(self) -> int:
        return hash((self.point, self.is_closed))
...
class Polygon(Path):
    ...
    def __init__(self, *point: typing.Sequence[float]) -> None:
        # polygon is always closed
        super().__init__(*point, is_closed=True)
